...
export const projects = sqliteTable('projects', {
  ...
  reportDate:            text('report_date').default(''),
  assessmentObject:      text('assessment_object').default(''),
  ...
  personnel:             text('personnel').default('{}'),
  agreedFee:             real('agreed_fee').default(0),
  actualFee:             real('actual_fee').default(0),
  clientContact:         text('client_contact').default(''),
  clientPhone:           text('client_phone').default(''),
  unitRegisteredCapital: text('unit_registered_capital').default(''),
  unitAddress:           text('unit_address').default(''),
  unitLegalRep:          text('unit_legal_rep').default(''),
  unitEnterpriseType:    text('unit_enterprise_type').default(''),
  unitContact:           text('unit_contact').default(''),
  unitPhone:             text('unit_phone').default(''),
  unitBusinessScope:     text('unit_business_scope').default(''),
  ...
  approvalRequired:      text('approval_required').default('否'),
  businessChanges:       text('business_changes').default(''),
  expertHired:           text('expert_hired').default(''),
  majorIssues:           text('major_issues').default(''),
  siteInspectors:        text('site_inspectors').default(''),
  siteContacts:          text('site_contacts').default(''),
  useAssetMethod:        integer('use_asset_method').default(0),
  useIncomeMethod:       integer('use_income_method').default(1),
  useMarketMethod:       integer('use_market_method').default(1),
})
