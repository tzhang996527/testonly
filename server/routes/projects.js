...
router.post('/', async (req, res) => {
  ...
  const newProject = {
    ...
    assessmentObject:      payload.assessmentObject      || '',
    ...
    agreedFee:             payload.agreedFee             || 0,
    actualFee:             payload.actualFee             || 0,
    clientContact:         payload.clientContact         || '',
    clientPhone:           payload.clientPhone           || '',
    unitRegisteredCapital: payload.unitRegisteredCapital || '',
    unitAddress:           payload.unitAddress           || '',
    unitLegalRep:          payload.unitLegalRep          || '',
    unitEnterpriseType:    payload.unitEnterpriseType    || '',
    unitContact:           payload.unitContact           || '',
    unitPhone:             payload.unitPhone             || '',
    unitBusinessScope:     payload.unitBusinessScope     || '',
    otherReportUsers:      payload.otherReportUsers      || '',
    relationship:          payload.relationship          || '',
    importantMatters:      payload.importantMatters      || '',
    assumptions:           payload.assumptions           || '',
    approvalRequired:      payload.approvalRequired      || '否',
    businessChanges:       payload.businessChanges       || '',
    expertHired:           payload.expertHired           || '',
    majorIssues:           payload.majorIssues           || '',
    siteInspectors:        payload.siteInspectors        || '',
    siteContacts:          payload.siteContacts          || '',
    useAssetMethod:        payload.useAssetMethod        ?? 0,
    useIncomeMethod:       payload.useIncomeMethod       ?? 1,
    useMarketMethod:       payload.useMarketMethod       ?? 1,
  }
