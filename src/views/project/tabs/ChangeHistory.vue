    ...
    <el-drawer v-model="drawerVisible" title="变更明细" size="600px" direction="rtl">
      <template v-if="detail">
        <el-descriptions :column="2" border size="small" style="margin-bottom:20px">
          ...
          <el-descriptions-item label="数据类型" :span="2">{{ entityTypeLabel(detail.entityType) }}</el-descriptions-item>
        </el-descriptions>
...
const filter = reactive({ dateRange: null, action: '', entityType: '' })
...
function resetFilter() {
  Object.assign(filter, { dateRange: null, action: '', entityType: '' })
  page.value = 1
  loadData()
}
